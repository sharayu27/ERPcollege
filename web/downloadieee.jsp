  ...
  <p><a href='http://all-free-download.com/free-website-templates/'></a><form method="POST">
    ...
    <br>
     <%
           ...
           String str = "select iname,tech from ieee";
           ResultSet rs = stmt.executeQuery(str);
           out.println("<table border='1' width='40%' align='center'>");
           out.println("<th>PapertName</th><th>Technology</th><th>Download</th>");
           while(rs.next())
           {
              out.println("<tr><td>"+rs.getString(1)+"</td>");
              out.println("<td>"+rs.getString(2)+"</td>");
              out.println("<td><a href=downieeepaper.jsp?proj="+rs.getString(2)+" '\'>Click</td></tr>");
           }
            }catch(Exception e)
            {
